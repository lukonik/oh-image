...
description: Use the Oh Image React image component for responsive images, placeholders, preload priority, and CDN loaders in Vite apps.
head:
  meta:
    - name: "keywords"
      content: "react image component, vite image component, responsive react images, react image placeholder, react image preload, vite image optimization"
    - property: "og:title"
      content: "React Image Component | Oh Image"
    - property: "og:description"
      content: "Use the Oh Image React image component for responsive images, placeholders, preload priority, and CDN loaders in Vite apps."
    - property: "og:type"
      content: "article"
    - property: "og:url"
      content: "https://lukonik.github.io/oh-image/docs/image"
    - name: "twitter:title"
      content: "React Image Component | Oh Image"
  ...
  links:
    - rel: "canonical"
      href: "https://lukonik.github.io/oh-image/docs/image"
---

The `Image` component is the core React image component in `oh-image`. It wraps the native `<img>`
