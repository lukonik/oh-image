---
title: Vite Image Plugin
description: Use the Oh Image Vite image plugin to import optimized images as React components with placeholders, dimensions, and responsive assets.
head:
  meta:
    - name: "keywords"
      content: "vite image plugin, vite image component, vite image optimization, react image imports, responsive image plugin, sharp image plugin vite"
    - property: "og:title"
      content: "Vite Image Plugin | Oh Image"
    - property: "og:description"
      content: "Use the Oh Image Vite image plugin to import optimized images as React components with placeholders, dimensions, and responsive assets."
    - property: "og:type"
      content: "article"
    - property: "og:url"
      content: "https://lukonik.github.io/oh-image/docs/vite-plugin"
    - name: "twitter:title"
      content: "Vite Image Plugin | Oh Image"
  ...
  links:
    - rel: "canonical"
      href: "https://lukonik.github.io/oh-image/docs/vite-plugin"
---


The `oh-image` Vite image plugin lets you import optimized images as React components. It intercepts your image imports, processes them using [Sharp](https://sharp.pixelplumbing.com/), and generates responsive assets ready for the web.
