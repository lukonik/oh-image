---
title: The Plugin
description: Comprehensive guide to the oh-image Vite plugin
---
...
When you import an image with `?oh`, the plugin doesn't just return a string. It returns a structured object that the `<Image />` component understands perfectly.

**The emitted object looks like this:**

```ts
{
  src: "/@oh-images/photo.webp", // Main image URL
  width: 1920,                  // Original width
  height: 1080,                 // Original height
  srcSet: "...",                // Responsive srcSet string
  placeholderUrl: "..."         // Data URI for blurred placeholder
}
```

You pass this directly to the `Image` component:
...
**Benefit:** Fast server start-up, even with thousands of images.
...
**Benefit:** Zero runtime overhead for users; maximum performance.
