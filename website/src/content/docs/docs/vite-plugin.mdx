...
These options can be passed globally or as query parameters.
...
To unset a default option (effectively setting it to `undefined` or `null`), pass the key name only.
